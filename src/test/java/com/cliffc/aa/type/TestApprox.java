...
public class TestApprox {
  ...
  @Test public void testApprox3() {
    ...
    Type.RECURSIVE_MEET++;
    TypeStruct x3 = TypeStruct.malloc("",false,flds3,TypeStruct.ts(3),finals3);
    ...
    Type.RECURSIVE_MEET++;
    TypeStruct x0 = TypeStruct.malloc("",false,flds3,TypeStruct.ts(3),finals3);
  ...
  @Test public void testApprox8() {
    ...
    TypeStruct arg3 = TypeStruct.make(xflds,TypeStruct.ts(Type.XSCALAR,ptr3,TypeInt.INT64),xmods);
