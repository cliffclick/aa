...
public class TestHM9 {
  ...
  @Before public void reset() { HM9.reset(); }
...
"(loop \"def\" (id 2))");
  ...
  @Test public void test49() {
    ...
    if( HM9.DO_GCP )
      if( HM9.DO_HM ) tfs(TypeMemPtr.make(7,TypeStruct.make_tuple(Type.ANY,TypeInt.con(3), TypeInt.NINT8 )));
