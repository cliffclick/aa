...
public class TestLift {
  ...
  @Test public void testLift2() {
    ...
    TypeStruct ts1 = TypeStruct.malloc_test(TypeFld.ANY_CLZ,fld1);
    ...
    TypeStruct ts2 = TypeStruct.make_test(TypeFld.ANY_CLZ,fld2);
    TypeMemPtr ret2 = TypeMemPtr.make(false,B3,ts2);
