...
import static com.cliffc.aa.HM.HM7.T2;
import static org.junit.Assert.assertEquals;

public class TestHM7 {

  @Before public void reset() { HM7.reset(); }
  ...
  @Test
  public void test03() {
    T2 t = HM7.hm("{ z -> (pair (z 3) (z \"abc\")) }");
    assertEquals("{ { all -> A } -> (pair A A) }",t.p());
  }

  @Test
  public void test04() {
    T2 t = HM7.hm("fact = { n -> (if (?0 n) 1 (* n (fact (dec n))))}; fact");
  ...
  public void test05() {
    ...
    T2 t1 = HM7.hm("({ x -> (pair (x 3) (x \"abc\")) } {y->y})");
  ...
  public void test08() {
    ...
    T2 t1 = HM7.hm("{ g -> f = { x -> g }; (pair (f 3) (f \"abc\"))}");
    assertEquals("{ A -> (pair A A) }",t1.p());
  }

  @Test
  public void test09() {
    T2 t1 = HM7.hm("{ f g -> (f g)}");
  ...
  public void test11() {
    ...
    T2 t1 = HM7.hm("map = { fun -> { x -> 2 } }; ((map 3) 5)");
    assertEquals("2",t1.p());
  }
  ...
  public void test12() {
    ...
    T2 t1 = HM7.hm("map = { fun -> { x -> (fun x)}}; { p -> 5 }");
  ...
  public void test14() {
    // map takes a function and an element (collection?) and applies it (applies to collection?)
    T2 t1 = HM7.hm("map = { fun x -> (fun x)}; (map {a->3} 5)");
    assertEquals("3",t1.p());
  }
  ...
  public void test15() {
    // map takes a function and an element (collection?) and applies it (applies to collection?)
    T2 t1 = HM7.hm("map = { fun x -> (fun x)}; (map { a-> (pair a a)} 5)");
    assertEquals("(pair 5 5)",t1.p());
  }

  @Test
  public void test16() {
    T2 t1 = HM7.hm("fcn = { p -> { a -> (pair a a) }};"+
                  "map = { fun x -> (fun x)};"+
                  "{ q -> (map (fcn q) 5)}");
  ...
  public void test17() {
    ...
    T2 t1 = HM7.hm("fcn = {p -> (if p {a -> (pair a a)} {b -> (pair b (pair 3 b))})};"+
                  "map = { fun x -> (fun x)};"+
                  "{ q -> (map (fcn q) 5)}");
  ...
  @Test
  public void test18() {
    T2 t1 = HM7.hm("cons ={x y-> {cadr -> (cadr x y)}};"+
  ...
  @Test
  public void test20() {
    T2 t1 = HM7.hm("f0 = { f x -> (if (?0 x) 1 (f (f0 f (dec x)) 2))}; (f0 * 99)");
  ...
  public void test21() {
    ...
    T2 t1 = HM7.hm("f0 = { f x -> (if (?0 x) 1 (* (f0 f (dec x)) 2))}; (f0 f0 99)");
    assertEquals("int64",t1.p());
  }
  ...
  @Test
  public void test25() {
    T2 t = HM7.hm(".x @{x =2, y =3}");
    assertEquals("2",t.p());
  }

  @Test
  public void test26() {
    T2 t = HM7.hm("{ g -> @{x=g, y=g}}");
  ...
  public void test27() {
    ...
    T2 t = HM7.hm("{ pred -> .x (if pred @{x=2,y=3} @{x=3,z= \"abc\"}) }");
  ...
  public void test29() {
    ...
    T2 t = HM7.hm("map = { fcn lst -> @{ n1 = (map fcn .n0 lst), v1 = (fcn .v0 lst) } }; map");
  ...
  public void test30() {
    ...
    T2 t = HM7.hm("map = { fcn lst -> (if lst @{ n1=(map fcn .n0 lst), v1=(fcn .v0 lst) } nil) }; map");
    assertEquals("{ { A -> B } C:@{ v0 = A, n0 = $C}? -> D:@{ n1 = $D, v1 = B}? }",t.p());
  }
  ...
  public void test31() {
    // Recursive linked-list discovery, with nil
    T2 t = HM7.hm("p0 = { x y z -> (triple x y z) };"+
                 "p1 = (triple p0 p0 p0);"+
                 "p2 = (triple p1 p1 p1);"+
                 "p3 = (triple p2 p2 p2);"+
                 "p3");
  ...
  public void test32() {
    ...
    T2 t = HM7.hm("map = { lst -> (if lst @{ n1= arg= .n0 lst; (if arg @{ n1=(map .n0 arg), v1=(str .v0 arg)} nil), v1=(str .v0 lst) } nil) }; map");
