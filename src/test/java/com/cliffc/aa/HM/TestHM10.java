...
public class TestHM10 {
  ...
  private static TypeStruct make_tups(Type t0, Type t1         ) {
    //return TypeStruct.make_test(t0,t1   );
    throw unimpl();
  }
  private static TypeStruct make_tups(Type t0, Type t1, Type t2) {
...
""",
        ...
        "( *[4]str, int1)",
        // With Lift ON
        TypeMemPtr.make(7,make_tups(TypeMemPtr.ISUSED,TypeInt.BOOL)),
        // With Lift OFF
        //tuple2,
        tuple2);
  }
