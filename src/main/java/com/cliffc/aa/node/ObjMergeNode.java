...
public class ObjMergeNode extends Node {
  ...
  ObjMergeNode( Node obj, int alias ) { super(OP_OBJ,obj); _alias=alias; _flds = new Ary<>(new String[1]); }

  Node obj() { return in(0); }
  ...
  @Override public Type value(GVNGCM gvn) {
    ...
    if( !(t instanceof TypeObj) ) {
      if( !(t instanceof TypeMem) ) throw AA.unimpl();
