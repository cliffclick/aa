...
public abstract class Cons {
  ...
  public static final TypeStruct CLZ_CLZ = TypeStruct.make(false,Type.ALL,TypeFlds.EMPTY);
  public static final TypeMemPtr CLZ_TMP = TypeMemPtr.make(BitsAlias.CLZX,CLZ_CLZ);
