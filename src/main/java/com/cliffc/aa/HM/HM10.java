...
public class HM10 {
  ...
  static class Lambda extends Syntax {
    ...
    @Override Type val(Worklist work) {
      ...
      return TypeFunPtr.makex(false,BitsFun.make0(_fidx),_args.length,Type.ANY,tret);
    }
  ...
  abstract static class PrimSyn extends Lambda {
    ...
    @Override Type val(Worklist work) {
      ...
      return TypeFunPtr.makex(false,BitsFun.make0(_fidx),_args.length,Type.ANY,ret);
    }
  ...
  static class T2 {
    ...
    Type _as_flow() {
      ...
      if( is_fun()  ) {
        ...
        return TypeFunPtr.make(false,ROOT_FREEZE ? BitsFun.NALL : _fidxs,size()-1,Type.ANY,rez);
      }
      if( is_struct() ) {
