...
public class TypeEnv{
  ...
  final TypeTuple _formals;     // If return flow is a TFP, also the top-level formals
  ...
  TypeEnv( Type t, BitsFun fidxs, BitsAlias aliases, TypeTuple formals, TypeMem tmem, TV2 hmt, ArrayList<ErrMsg> errs ) {
